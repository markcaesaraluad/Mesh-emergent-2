<template>
  ...
  <div class="flex-auto justify-center flex flex-col pb-8">
    ...
    <router-link class="font-semibold leading-6 text-biege-700 hover:text-biege-600" to="/signup">Register now!</router-link>
  </p>
  
  <!-- <div class="text-center mt-2">
    <a href="#" class="text-biege-700 hover:text-biege-600 text-sm">Forgot password?</a>
  </div> -->
