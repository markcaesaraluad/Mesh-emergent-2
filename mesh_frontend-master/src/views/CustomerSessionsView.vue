<template>
  ...
  <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
    ...
    <table class="min-w-full divide-y divide-gray-300">
                          ...
                          <tr class="text-white">
                              ...
                              <th scope="col" class="py-4 px-4 text-gray-500 font-bold text-left text-sm sm:pl-4 w-auto">Status</th>
                          ...
                          <tr v-for="i in alldata" v-bind:key="i.id" class="hover:bg-gray-200">
                            ...
                            <td class="py-4 px-4 text-sm text-gray-500 sm:pl-6 w-auto"> {{i.user_id.user_id}}</td>

                            <td class="py-4 px-4 text-sm text-gray-500 sm:pl-6 w-auto">
  ...
  getAll(type,name){
    ...
    if(name){
      ...
      axios.get(process.env.VUE_APP_BASE_URL + '/user_sessions/get_all_filter/' + this.page + '/' + this.page_limit + '/' + type + '/' + name)
      .then((res)=>{
      ...
      axios.get(process.env.VUE_APP_BASE_URL + '/user_sessions/get_all/' + this.page + '/' + this.page_limit)
      .then((res)=>{
