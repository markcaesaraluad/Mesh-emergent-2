<template>
  ...
  getAll(type,name){
    ...
    if(name){
      ...
      axios.get(process.env.VUE_APP_BASE_URL + '/user/get_all_filter/' + this.page + '/' + this.page_limit + '/' + 'customer' + '/' + type + '/' + name)
      .then((res)=>{
      ...
      axios.get(process.env.VUE_APP_BASE_URL + '/user/get_all/' + this.page + '/' + this.page_limit + '/' + 'customer')
      .then((res)=>{
