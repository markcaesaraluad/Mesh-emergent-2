...
@Controller('time_shifts')
export class TimeShiftsController {

    constructor(private i_service: TimeShiftsService) {
    ...
    @Post('add')
    async addItem(@Body() createUserOto: TimeShiftsEntity){
